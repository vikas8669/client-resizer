...
export function Hero() {
  return (
    <section className="relative pt-32 md:pt-48 pb-20 bg-background overflow-hidden flex flex-col items-center">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center flex flex-col items-center">
        <div className="flex flex-col items-center">
          {/* Finta Top Pill Badge */}
          <a href="#how-it-works" className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-zinc-100 dark:bg-white/5 border border-zinc-200 dark:border-white/10 text-zinc-600 dark:text-zinc-300 text-sm font-medium mb-8 hover:bg-zinc-200 transition-colors">
            🎉 Announcing ImageSaaS 2.0 <ArrowRight className="w-3 h-3" />
          </a>
          
          {/* Finta Massive Headline */}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
            ...
            <motion.a
              ...
              whileTap={{ y: 0 }}
              href="#how-it-works"
              className="w-full sm:w-auto flex items-center justify-center px-8 py-4 rounded-full bg-white dark:bg-white/5 text-[#1E1F25] dark:text-white border border-zinc-200 dark:border-white/10 font-semibold text-base shadow-sm hover:bg-zinc-50 transition-all"
            >
              See how it works
            </motion.a>
          </div>
