...
export function HowItWorks() {
  return (
    <section id="how-it-works" className="py-16 md:py-32 bg-white dark:bg-zinc-950 relative border-t border-zinc-100 dark:border-white/5 transition-colors duration-500 overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-6xl relative z-10">
        <div className="text-center mb-12 md:mb-28 px-2">
          ...
          <p className="text-base md:text-xl text-zinc-500 dark:text-zinc-400 font-medium">
            No complex manuals. Just an incredibly fluid workflow.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 relative">
          {/* Animated Decorative Connecting Line */}
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="relative p-8 md:p-10 rounded-[2rem] bg-white/80 dark:bg-zinc-900/80 backdrop-blur-sm border border-zinc-200/50 dark:border-white/5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] h-full overflow-hidden flex flex-col items-center text-center">
                ...
                <div className="w-16 h-16 rounded-full bg-zinc-50 dark:bg-zinc-800 border border-zinc-100 dark:border-white/10 flex items-center justify-center mb-8 shadow-sm group-hover:scale-110 group-hover:shadow-md transition-all duration-300">
                  <span className="text-2xl font-bold text-[#1E1F25] dark:text-white tracking-tighter">
                    {step.number}
                  </span>
                </div>

                <h3 className="text-2xl font-bold text-[#1E1F25] dark:text-white mb-4 tracking-tight">
                  {step.title}
                </h3>
