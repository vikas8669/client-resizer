...
export default function SolutionsPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_10%_20%,#fef3c7_0%,transparent_45%),radial-gradient(circle_at_85%_10%,#bfdbfe_0%,transparent_45%),linear-gradient(180deg,#fff7ed_0%,#ffffff_60%)] py-16 px-4 sm:px-6">
      ...
      <div className="mx-auto w-full max-w-4xl">
        <div className="mb-12 text-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 rounded-full border border-orange-200 bg-amber-50 px-4 py-1.5 text-sm font-semibold text-amber-800 mb-4"
          >
        ...
        <div className="space-y-8">
          {isLoading ? (
            ...
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="rounded-3xl border border-dashed border-zinc-300 bg-white/50 p-12 text-center"
            >
              <Lightbulb className="h-12 w-12 text-zinc-300 mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-zinc-900">No resolved suggestions yet</h3>
              <p className="mt-2 text-zinc-600">Be the first to share a great idea on our product page!</p>
            ...
            resolvedFeedback.map((item, index) => (
              <motion.article
                ...
                className="group relative rounded-3xl border border-orange-100 bg-white/90 p-8 shadow-sm backdrop-blur-sm transition-all hover:shadow-xl hover:border-orange-200"
              >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-sm font-bold text-zinc-900">Suggestion from {item.name || 'Anonymous'}</span>
                    ...
                    <div className="mt-6 relative">
                      ...
                      <div className="pl-6">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="text-sm font-bold text-emerald-700 uppercase tracking-wider">Solution Implemented</span>
                        </div>
        ...
        <div className="mt-16 text-center">
          <Link
            href="/product"
            className="inline-flex items-center gap-2 rounded-2xl border border-zinc-200 bg-white px-8 py-3 text-sm font-semibold text-zinc-900 shadow-sm transition-all hover:bg-zinc-50 hover:border-zinc-300"
          >
